...
![](man/figures/greenspaces_euclidean.png)
...
```{r}
greenspace_access(df_point, buffer_distance=300, euclidean = F, pseudo_entrance = T, network_file = GreenExp::network_file)
```
